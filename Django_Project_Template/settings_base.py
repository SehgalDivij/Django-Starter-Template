...
# Note: You should generate a pristine Secret Key  as a security measure.
SECRET_KEY = '%edwtjj8e+-xo0e5ywz_w!eelu31t#@_n+ovfe+_$j)8y-6sxi'
...
# Most of my apps use an API first approach.
REST_FRAMEWORK = {
